...
# 2. Перебрать пары с расстоянием по индексам не менее K
k = 3
...
# Здесь j - i >= k.
# Если по условию должно быть не менее K элементов МЕЖДУ ними,
# нужно j - i - 1 >= k, то есть начинать с i + k + 1.
